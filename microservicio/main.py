...
app.add_middleware(
    CORSMiddleware, 
    allow_origins=["*"], # -> Aqui solo debe ir el link de la app
...
async def mover_aventurero(
    ...
    if result.rowcount == 0:
        raise HTTPException(status_code=404, detail="Aventurero no encontrado")
    
    return {"mensaje": "movimienot exitoso", "id":aventurero_id, "estado": movimiento.nuevo_estado}
