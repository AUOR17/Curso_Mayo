...
export default function ReclutarAventureroModal({ isOpen, onClose, onSuccess, gremios }: Props) {
     ...
     * useEffect(() => {
      // Código...
    }, [miVariable]); // <-- SÍ hay corchetes, y tienen algo adentro.
     */
    ...
    const manejarEnvio = async (e: React.SyntheticEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            alert("Error al conectar con el grmeio")
        }
    };
    ...
    return(
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex justify-center items-center z-50">
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 w-96 shadow-2xl">
                <h2 className="text-2xl font-bold text-amber-400 mb-6 border-b border-gray-700 pb-2">Nuevo Recluta</h2>
                <form onSubmit={manejarEnvio}>
                    <div className="mb-8">
                       <label className="block text-gray-400 text-sm font-bold mb-2">Nombre del Recluta</label>
                       <input
                       type='text'
                       value={nombre}
                       ...
                       placeholder='Ej. Carlos Cristian'
                       required
                       />
                    </div>
                    ...
                    <div className="mb-8">
                       <label className="block text-gray-400 text-sm font-bold mb-2">Asignar a Gremio</label>
                       <select
                       value={gremioId}
