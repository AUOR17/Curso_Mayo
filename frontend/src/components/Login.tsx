...
export default function Login(){
    ...
    const manejarLogin = async (e: React.SyntheticEvent<HTMLFormElement>) => {
            e.preventDefault();
            setError('');
            ...
            try {
                ...
                console.error(err);
                setError('Credenciales invalidas. El gremio no reconoce');
            }
    };
    ...
    return(
        <div className="flex justify-center items-center h-[70vh]">
            <form  onSubmit={manejarLogin} className="bg-gray-800 p-8 rounded-xl border border-gray-700 shadow-2xl w-96">
                ...
                <button
                    type="submit"
                    className="w-full bg-linear-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white font-bold py-2 px-4 rounded transition-all"
                >
                    Iniciar Sesion
                </button>
            </form>
