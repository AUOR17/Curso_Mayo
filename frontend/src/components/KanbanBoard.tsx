...
export default function KanbanBoard() {
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            try {
                ...
                console.error("Error al invocar aventurero", error)
            }
        };
    ...
    const onDragEnd = async (result: DropResult) => {
        ...
        console.log("¡Éxito en Backend!", respuesta.data);
        } 
        catch (error) {
        console.error("El backend rechazó el movimiento:", error);
        setColumnas(estadoAnterior);
        alert(`El movimiento de ${aventureroMovido.nombre} fue denegado por el Gremio.`);
        }
    ...
    return(
        ...
        <div className="flex justify-between items-center mb-6">
            ...
            <div>
                ...
                className="bg-amber-600 hover:bg-amber-500 text-white font-bold py-2 px-4 rounded shadow-lg transition-all"
                >
                    + Reclutar Aventurero
                </button>
            </div>
