  ...
  return (
    ...
    >
      <div 
        ...
        style={{ 
          transform: isSpinning ? 'rotateY(1080deg) scale(0.95)' : 'rotateY(0deg) scale(1)',
      ...
      >
        <div className="flex justify-between items-start mb-4 gap-2">
          <div className="flex-1">
            ...
            <p className="text-sm text-rpg-silver mt-1 line-clamp-1">{lead.race_class}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-rpg-dark/50 p-3 rounded flex flex-col items-center border border-rpg-blood/10">
            ...
            <span className="font-bold text-rpg-bone text-lg">{lead.threat_level}%</span>
          </div>
          <div className="bg-rpg-dark/50 p-3 rounded flex flex-col items-center border border-rpg-gold/10">
            ...
            <span className="font-bold text-rpg-bone text-sm">${lead.estimated_reward}</span>
          </div>
        </div>
