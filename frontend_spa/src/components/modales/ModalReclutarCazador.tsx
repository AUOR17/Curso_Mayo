...
export default function ModalReclutarCazador({ onClose, onSuccess }: ModalProps) {
  ...
  return (
    ...
    >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-rpg-bone text-sm font-bold mb-1">Nombre de Héroe (Sin espacios)</label>
            <input
              type="text"
              required
              value={username}
          ...
          <div>
            <label className="block text-rpg-bone text-sm font-bold mb-1">Contraseña Provisional</label>
            <input
              type="password"
              required
              value={password}
          ...
          <div>
            <label className="block text-rpg-bone text-sm font-bold mb-1">Clase de Combate</label>
            <select
              value={role}
