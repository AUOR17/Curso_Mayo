// frontend_spa/src/components/modales/ModalAsignarGremio.tsx
...
export default function ModalAsignarGremio({onClose, onSuccess, maestroId, maestroNombre }: ModalProps) {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error("Error al asignar la sede:", err);
