...
export default function ModalCrearMonstruo({ onClose, onSuccess }: ModalProps) {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error("Error al registrar la bestia:", err);
      setError("No se pudo registrar. Revisa que los datos sean correctos.");
    } finally {
      setLoading(false);
    }
  };
