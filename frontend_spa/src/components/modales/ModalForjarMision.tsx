  ...
  return (
    ...
    >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          {error && <div className="bg-rpg-blood/20 border border-rpg-blood text-rpg-parchment px-4 py-2 rounded text-sm">{error}</div>}

          <div>
            <label className="block text-rpg-bone text-sm font-bold mb-1">Título de la Misión</label>
          ...
          <div>
            <label className="block text-rpg-bone text-sm font-bold mb-1">Descripción</label>
          ...
          <div className="flex gap-4">
            <div className="w-1/2">
              <label className="block text-rpg-bone text-sm font-bold mb-1">Nivel (1-100)</label>
              <input type="number" min="1" max="100" required value={difficultyLevel} onChange={(e) => setDifficultyLevel(Number(e.target.value))}
                className="w-full bg-rpg-dark text-rpg-parchment border border-rpg-blood/30 rounded py-2 px-3 focus:outline-none focus:border-rpg-blood"
              />
            </div>
            <div className="w-1/2">
              <label className="block text-rpg-bone text-sm font-bold mb-1">Recompensa</label>
              <input type="number" step="100" min="0" max="99999999.99" required value={potentialReward} onChange={(e) => setPotentialReward(e.target.value)} placeholder="0.00"
                className="w-full bg-rpg-dark text-rpg-parchment border border-rpg-blood/30 rounded py-2 px-3 focus:outline-none focus:border-rpg-blood"
              />
            </div>
          </div>
          ...
          {user?.role === 'GRAN_MAESTRO' && (
            <div>
              <label className="block text-rpg-bone text-sm font-bold mb-1">Sede Asignada (Opcional)</label>
