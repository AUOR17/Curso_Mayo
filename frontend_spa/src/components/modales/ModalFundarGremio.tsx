  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-rpg-bone text-sm font-bold mb-1">Nombre del Gremio</label>
          <input
            type="text"
            required
            value={nombre}
        ...
        <div>
          <label className="block text-rpg-bone text-sm font-bold mb-1">Descripción (Opcional)</label>
          <textarea
            value={descripcion}
