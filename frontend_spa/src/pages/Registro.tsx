...
export default function Registro() {
  ...
  const handleRegister = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert("¡Reclutamiento exitoso! Las puertas del Gremio se han abierto para ti.");
      navigate('/login');
    } catch (err: any) {
      console.error("Fallo al forjar el nuevo cazador:", err);
      setError("Ese nombre de héroe ya está reclamado o los datos son inválidos.");
    }
  };
      ...
      <div className="max-w-md w-full bg-[#141614] border border-rpg-blood/30 rounded-xl shadow-[0_0_30px_rgba(130,23,21,0.15)] p-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-rpg-silver">
            ...
            <Link to="/login" className="text-rpg-gold hover:text-white transition-colors underline decoration-rpg-gold/50">
