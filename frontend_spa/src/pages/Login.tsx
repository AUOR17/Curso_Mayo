...
export default function Login() {
  ...
  const handleLogin = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError('Credenciales incorrectas o los escudos del servidor están arriba.');
    }
  };
      ...
      <div className="max-w-md w-full bg-[#141614] border border-rpg-blood/30 rounded-xl shadow-[0_0_30px_rgba(130,23,21,0.15)] p-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-rpg-silver">
            ...
            <Link to="/register" className="text-rpg-gold hover:text-white transition-colors underline decoration-rpg-gold/50">
